...
public:
    ...
    void setupUi(QDialog *dialog)
    {
        ...
        buttonBox->setGeometry(QRect(130, 450, 350, 35));
        ...
        line->setGeometry(QRect(20, 380, 460, 20));
        line->setFrameShape(QFrame::HLine);
        line->setFrameShadow(QFrame::Sunken);
        tabWidget = new QTabWidget(dialog);
        tabWidget->setObjectName(QString::fromUtf8("tabWidget"));
        tabWidget->setGeometry(QRect(10, 30, 480, 350));
        QFont font1;
        ...
        formLayoutWidget->setGeometry(QRect(20, 20, 451, 281));
        ...
        horizontalLayoutWidget->setGeometry(QRect(20, 400, 461, 51));
