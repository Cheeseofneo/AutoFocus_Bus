...
/************************************************************************
 *  @fn     MV_GIGE_ForceIpEx
 *  @brief  强制设置局域网内所有相机的IP
 *  @param  handle：设备句柄
 *  @param  nIP               [IN]      设置的IP
 *  @param  nSubNetMask       [IN]      子网掩码, 0表示默认
 *  @param  nDefaultGateWay   [IN]      默认网关 0表示默认
 *  @return 见返回错误码
************************************************************************/
MV_CAMCTRL_API int __stdcall MV_GIGE_ForceAllIPAddressesAutomatically(unsigned int nSubNetMask, unsigned int nDefaultGateWay);
